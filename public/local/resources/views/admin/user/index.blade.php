                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="35%" style="text-align: right">
                                        <a href="javascript::void()" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle <?php if($row->open == 1){ echo "btn-success"; } else { echo "btn-danger" ; } ?>" data-toggle="tooltip" data-placement="top" data-original-title="
                                            <?php if($row->open == 1){ echo "Mở cửa ngay bây giờ"; } else { echo "Đóng cửa ngay bây giờ"; } ?>" onclick="confirmAlert('{{ Asset($link.'status/'.$row->id.'?type=open') }}')"><i class="mdi mdi-disc"></i></a>
